...
// ---------------------------------------------------------------------------
// Cross-CSE (generate_csd_multipliers) tests
// ---------------------------------------------------------------------------

TEST_CASE("csd_multipliers empty coeffs") {
    CHECK_THROWS_AS(generate_csd_multipliers({}), std::invalid_argument);
}
...
TEST_CASE("csd_multipliers shared pattern cross-CSE") {
    ...
    CHECK(v.find("endmodule") != std::string::npos);
    CHECK(v.find("c1") != std::string::npos);
    CHECK(v.find("c2") != std::string::npos);
    CHECK(v.find("x_shift4") != std::string::npos);
}
...
TEST_CASE("csd_multipliers single coefficient") {
    ...
    CHECK(v.find("module csd_filter") != std::string::npos);
    CHECK(v.find("x_shift2") != std::string::npos);
    CHECK(v.find("x_shift0") != std::string::npos);
    CHECK(v.find("_cse_0") == std::string::npos);
}
